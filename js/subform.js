...
$(function() {
$("#pluss3").click(function(e) {
    

var state = document.getElementById('fondoexperiencia4').style.display;
if (state == 'block') {
    document.getElementById('fondoexperiencia4').style.display = 'none';
}
else {
    document.getElementById('fondoexperiencia4').style.display = 'block';
}
e.preventDefault();
$("#pluss3").attr("hidden", "hidden");
var elem = document.getElementById('plus3');
elem.style.backgroundColor = "white";
