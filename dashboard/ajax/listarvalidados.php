...
if($action == 'ajax'){
	...
	$query = mysqli_query($con,"SELECT $campos FROM  $tables where estado=1 LIMIT $offset,$per_page");
			...
			<table class="table table-striped table-hover">
				...
				<tbody>	
						...
						<tr>
							...
							<td>
								<a href="#"  data-target="#editProductModalValidada" class="edit" data-toggle="modal" data-id='<?php echo $id?>' data-estado='<?php echo $estado; ?>'><i class="material-icons" data-toggle="tooltip" title="Editar" >&#xE254;</i></a>
